...
class Cavalo(Mamifero):
    ...
    def __init__(self, nome, cor_pelo, idade, cor_pata, cor_crina):
        super().__init__(nome, cor_pelo, idade, cor_pata)
...
class Cachorro(Mamifero):
    ...
    latir() e rosnar()
    """
    def __init__(self, nome, cor_pelo, idade, cor_pata, raca):
        super().__init__(nome, cor_pelo, idade, cor_pata)
        self.raca = raca
...
class Gato(Mamifero):
    ...
    """
    def __init__(self, nome, cor_pelo, idade, cor_pata, vidas):
        super().__init__(nome, cor_pelo, idade, cor_pata)
